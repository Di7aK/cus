...
public class Mail {
    ...
    public static void typing(Session session, UserData user, String message) throws SpacesException {
        StringBuilder args = new StringBuilder();
        args.append("method=").append("typing")
            .append("&Contact=").append(Uri.encode(user.id))
            .append("&sid=").append(Uri.encode(session.sid))
            .append("&CK=").append(Uri.encode(session.ck))
            .append("&No_notify=").append(1)
